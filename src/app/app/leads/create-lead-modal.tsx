    ...
    <>
      ...
      {isOpen ? (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-stone-950/80 p-4 backdrop-blur-sm">
          <div className="relative flex max-h-[90vh] w-full max-w-3xl flex-col overflow-hidden rounded-[2rem] border border-stone-800 bg-stone-900 shadow-2xl shadow-black/40">
            <div className="flex items-start justify-between gap-4 border-b border-stone-800 px-5 py-5 md:px-6">
              <div>
                ...
                <h2 className="mt-2 text-2xl font-semibold">Cadastro manual</h2>
                <p className="mt-2 text-sm leading-6 text-stone-300">
                  Use este formulario para inserir leads manualmente sem sair da
                  tela de operacao.
                </p>
              </div>
